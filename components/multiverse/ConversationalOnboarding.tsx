    ...
    if (USE_CLAUDE_CHAT) {
      ...
      if (claudeResponse.isComplete) {
        ...
        const finalProfile: ArtistProfile & { releases?: any[] } = {
          ...
          hasExistingAssets: (claudeProfileData.current as any).hasExistingAssets,
          existingAssetsDescription: (claudeProfileData.current as any).existingAssetsDescription,
          editedClipCount: (claudeProfileData.current as any).editedClipCount,
          rawFootageDescription: (claudeProfileData.current as any).rawFootageDescription,
