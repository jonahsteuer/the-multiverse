...
Plans:
- [ ] 01-PLAN.md — Apify field enrichment: extend types, analyzePost, buildAccountSummary with audio/music, hashtag ER, carousel detection, caption tone; bump maxDuration to 300s
